# 💫 About Me:
Hi There 👋🏽, I'm Simon Ddungu!<br>💻 A Computer Science Major passionate about coding and learning new technologies.<br>Skills<br>Languages: C, C++, Java, JavaScript<br>Frameworks: React, Node.js, JavaFx.<br>Tools: Git, VS Code, CodeBlocks, IntelliJ IDEA<br>Learning Goals<br>Machine Learning and AI<br>Web Development<br>Data Structures and Algorithms<br>Connect with Me<br>Instagram<br>Thanks for visiting my GitHub! ⭐️
